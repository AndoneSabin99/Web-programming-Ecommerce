...
public class RemoveFromCartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String product = request.getParameter("removedProduct");
        HttpSession session = request.getSession(true);

        Carrello cart = (Carrello)session.getAttribute("carrello");
        
        Product productToBeRemoved = new Product("","","");
        /*cerco il prodotto nel carrello, per poi eliminarlo dopo.
        In questo modo si evita l'errore di ConcurrentModificationException*/
