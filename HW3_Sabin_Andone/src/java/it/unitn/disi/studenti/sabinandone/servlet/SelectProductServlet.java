...
public class SelectProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SelectProductServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SelectProductServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String product = request.getParameter("selectedProduct");
        ...
        for(Product p: productList){
            if (product.equals(p.getName())){
                ...
                context.setAttribute("description",p.getDescription());
                context.setAttribute("price",p.getPrice());
